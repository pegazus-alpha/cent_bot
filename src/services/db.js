...
export const createOrUpdateUser = async (jid, name, role = 'member') => {
...
export const saveMessage = async (id, jid, groupId, body, mediaPath) => {
    await db('messages')
        .insert({
        id,
        jid,
...
export const logModeration = async (jid, action, reason) => {
